...
class AWSOperations:  # pragma: no cover
    ...
    @staticmethod
    def aws_get_connection(**kwargs: str) -> Dict[str, str]:  # pragma: no cover
        """Get AWS Connection.
    ...
    def aws_delete_s3_bucket(self, **kwargs: str) -> bool:  # pragma: no cover
        """Delete S3 bucket.
    ...
    def aws_list_s3_buckets(self, **kwargs: str) -> List[str]:  # pragma: no cover
        """List S3 buckets.
    ...
    def aws_sqs_send_message(self, **kwargs: str) -> bool:  # pragma: no cover
        """Send sqs message.
    ...
    def aws_iam_create_user(self, **kwargs: str) -> bool:  # pragma: no cover
        """IAM create user.
